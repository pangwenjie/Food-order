...
<?php
	class registerController extends registerEntity{
				...
				&& (isset($_POST['emailError']) !== '')){
					if((isset($_POST['nameError']) == true) 
						...
						&& (isset($_POST['emailError']) == true)){
							...
							$result1 = $this->getCustomerDetails($name, $dateOfBirth, $phoneNumber, $email);
							
							if($result1->num_rows == 0){

								$result = $this->insertAccount($name, $password, $dateOfBirth, $phoneNumber, $email, $userType);
